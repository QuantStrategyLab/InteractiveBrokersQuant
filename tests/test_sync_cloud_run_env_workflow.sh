...
grep -Fq 'STRATEGY_PROFILE=${STRATEGY_PROFILE},ACCOUNT_GROUP=${ACCOUNT_GROUP},IB_ACCOUNT_GROUP_CONFIG_SECRET_NAME=${IB_ACCOUNT_GROUP_CONFIG_SECRET_NAME}' "$workflow_file"
