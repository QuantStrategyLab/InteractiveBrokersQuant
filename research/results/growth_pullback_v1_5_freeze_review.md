...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| tech_pullback_cash_buffer | cash-buffered parallel branch | 0.234811 | 0.340680 | 0.238732 | -0.191763 | -0.120121 | 2.646607 | 5.898990 | 0.800000 | 0.502781 | 0.256476 | 0.874353 |
...
| config_name_matches_canonical_name | True | config_name=tech_pullback_cash_buffer, canonical_name=tech_pullback_cash_buffer |
...
| recommendation_matches_branch_default_role | True | recommendation=tech_pullback_cash_buffer |
...
| --- | --- | --- | --- | --- |
| tech_pullback_cash_buffer | cash-buffered parallel branch | cash_buffer_a__hb10__base__adv50 | QQQ | Research-only parallel stock branch for concentrated tech leaders bought on controlled pullbacks with an explicit 20% cash/BOXX buffer in risk-on. |